...
export function FeaturesSection() {
  return (
    <>
      <div className="w-full px-4 lg:px-24 border-b-[0.7px] border-light-gray/50">
        <div className="w-full border-x-[0.7px] border-light-gray/50 lg:px-8 px-4 pt-16 lg:pt-36 pb-6 lg:pb-12">
          <h2 className="lg:text-5xl text-2xl max-w-209 leading-[120%] tracking-[-4%] ">
